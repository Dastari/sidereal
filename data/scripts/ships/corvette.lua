return {
  ...
  entity_labels = { "Ship", "Corvette" },
  tags = { "starter", "combat", "small" },

  visual = {
    visual_asset_id = "corvette_01",
  ...
  hardpoints = {
    ...
    },
    {
      ...
      display_name = "Scanner Dorsal",
      slot_kind = "scanner",
      offset_m = { 0.0, 2.5, 0.0 },
      local_rotation_rad = 0.0,
      compatible_tags = { "scanner" },
    },
    {
  ...
  mounted_modules = {
    ...
    { hardpoint_id = "scanner_dorsal", module_id = "module.scanner.array_mk1", component_overrides = {} },

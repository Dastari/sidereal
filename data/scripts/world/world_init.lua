...
WorldInit.world_defaults = {
  ...
  starter_star = {
    ...
    sun_intensity = 1.0,
    surface_saturation = 1.16,
    surface_contrast = 1.36,
    light_color_mix = 0.0,
    color_primary_rgb = { 1.0, 0.78, 0.26 },
    color_secondary_rgb = { 1.0, 0.42, 0.08 },
    color_tertiary_rgb = { 0.48, 0.06, 0.02 },
    color_atmosphere_rgb = { 1.0, 0.3, 0.06 },
    color_clouds_rgb = { 1.0, 0.96, 0.72 },
    color_night_lights_rgb = { 0.0, 0.0, 0.0 },
    color_emissive_rgb = { 1.0, 0.58, 0.12 },
    map_icon_asset_id = "map_icon_star_svg",
    sprite_shader_asset_id = "star_visual_wgsl",
  },

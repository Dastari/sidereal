local StarterCorvette = {}

StarterCorvette.context = {}
...
local function corvette_collision_outline_points(ctx)
  if ctx.default_corvette_collision_outline_points ~= nil then
...
function StarterCorvette.build_graph_records(ctx)
  ...
  local records = {
    ...
    new_entity(
      ...
      nil,
      {
        component(ship_id, "display_name", "Corvette"),
        component(ship_id, "ship_tag", {}),
        component(ship_id, "entity_labels", { "Ship", "Corvette" }),
        ...
        component(ship_id, "owner_id", ctx.player_entity_id),
        ...
        component(ship_id, "avian_position", { spawn_x, spawn_y }),
    ...
    new_entity(
      ...
      ship_id,
      {
        ...
        component(hardpoint_computer_core_id, "owner_id", ctx.player_entity_id),
      }
    ),
    new_entity(
      ...
      ship_id,
      {
        ...
        component(hardpoint_engine_main_aft_id, "owner_id", ctx.player_entity_id),
      }
    ),
    new_entity(
      ...
      ship_id,
      {
        ...
        component(hardpoint_fuel_left_id, "hardpoint", {
          ...
          offset_m = { -3.0, 1.5, -8.0 },
        }),
        component(hardpoint_fuel_left_id, "parent_guid", ship_id),
        component(hardpoint_fuel_left_id, "owner_id", ctx.player_entity_id),
      }
    ),
    new_entity(
      ...
      ship_id,
      {
        ...
        component(hardpoint_fuel_right_id, "owner_id", ctx.player_entity_id),
      }
    ),
    new_entity(
      ...
      ship_id,
      {
        ...
        component(hardpoint_weapon_fore_center_id, "hardpoint", {
          ...
          offset_m = { 0.0, 10.0, -10.0 },
        }),
        component(hardpoint_weapon_fore_center_id, "parent_guid", ship_id),
        component(hardpoint_weapon_fore_center_id, "owner_id", ctx.player_entity_id),
      }
    ),
    new_entity(
    ...
    new_entity(
      ...
      hardpoint_engine_main_aft_id,
      {
        ...
        component(module_engine_main_id, "owner_id", ctx.player_entity_id),
        ...
        component(module_engine_main_id, "thruster_plume_shader_settings", {
          ...
          base_color_rgb = { 0.35, 0.68, 1.2 },
          hot_color_rgb = { 0.7, 0.92, 1.3 },
          afterburner_color_rgb = { 1.0, 1.0, 1.4 },
        }),
      }
    ),
    new_entity(
      ...
      hardpoint_fuel_left_id,
      {
        ...
        component(module_fuel_tank_left_id, "owner_id", ctx.player_entity_id),
    ...
    new_entity(
      ...
      hardpoint_fuel_right_id,
      {
        ...
        component(module_fuel_tank_right_id, "owner_id", ctx.player_entity_id),
    ...
    new_entity(
      ...
      hardpoint_weapon_fore_center_id,
      {
        ...
        component(module_weapon_gatling_fore_id, "owner_id", ctx.player_entity_id),

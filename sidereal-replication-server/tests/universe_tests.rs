...
use sidereal_core::ecs::components::{SpatialPosition, BoundaryDirection, UniverseConfig, UniverseState, EntityApproachingBoundary, is_approaching_boundary};
...
fn test_sector_calculation() {
    ...
    let positions = vec![
        ...
        (Vec2::new(1000.0, 1000.0), IVec2::new(1, 1), IVec2::new(0, 0)), // Just inside second sector
        (Vec2::new(-1.0, -1.0), IVec2::new(-1, -1), IVec2::new(-1, -1)), // Negative coordinates
        (Vec2::new(3500.0, 2500.0), IVec2::new(3, 2), IVec2::new(1, 0)), // Further out
    ];
...
fn test_entity_sector_update() {
    ...
    let spatial_pos = {
        let world = app.world();
        world.entity(entity).get::<SpatialPosition>().unwrap().clone()
    };

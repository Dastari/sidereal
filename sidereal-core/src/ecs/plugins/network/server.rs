use crate::ecs::systems::network::{
    handle_server_events, receive_server_message_system, send_message_system, NetworkMessageEvent,
};
use bevy::prelude::*;
...
impl Plugin for NetworkServerPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(Update, (send_message_system, receive_server_message_system));
    }
}

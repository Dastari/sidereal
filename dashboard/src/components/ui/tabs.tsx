...
function Tabs({
  ...
  return (
    <TabsPrimitive.Root
      data-slot="tabs"
      className={cn('grid-tabs flex flex-col gap-2', className)}
      {...props}
    />
  )
}
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ...
    data-slot="tabs-list"
    className={cn(
      'grid-tabs-list bg-muted text-muted-foreground inline-flex h-9 w-fit items-center justify-center p-[3px]',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ...
    className={cn(
      'grid-tabs-content flex-1 outline-none',
      className,
    )}
    {...props}
  />

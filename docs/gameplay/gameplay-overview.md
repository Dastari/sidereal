[← Back to Documentation Index](../README.md) | [Design Phases](./design-phases.md) | [Game World Partitioning](../architecture/game-world.md)
...
- **Block-Based Building**: Ships and stations are constructed from blocks placed on a grid
- **Hull Size Variety**: Multiple hull sizes determine the overall capacity for components
- **Component Types**:
  - Armor (with various shapes for aesthetics and protection)
  - Weapons (beam weapons, projectiles, missiles)
  - Shield generators
  - Tractor beams
  - Jump drives
  - Reactors and power distribution
  - Cargo bays
  - Hangar bays
  - Sensor arrays
  ...
  - Cloaking devices
  - Resource harvesters
- **Interior Design**: Customizable layouts for larger ships and stations
- **Visual Customization**: Color schemes, decals, insignias, and ship naming
- **Ship Classes**: Specialization of vessels for specific roles (combat, mining, transport, etc.)
- **Module Variations**: Components with different stats, strengths, and weaknesses
